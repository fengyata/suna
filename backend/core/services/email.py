...
class EmailService:
    def __init__(self):
        ...
        self.sender_name = os.getenv('MAILTRAP_SENDER_NAME', 'SuperAgent Team')
    ...
    def send_welcome_email(self, user_email: str, user_name: Optional[str] = None) -> bool:
        ...
        subject = "🎉 Welcome to SuperAgent — Let's Get Started "
    ...
    def send_referral_email(
        ...
        try:
            ...
            mail = mt.Mail(
                sender=mt.Address(email=sender_email_to_use, name='SuperAgent'),
...
<body>
  <div class="container">
    <div class="logo-container">
      <img src="https://heprlhlltebrxydgtsjs.supabase.co/storage/v1/object/public/image-uploads/loaded_images/Profile%20Picture%20Black.png" alt="SuperAgent Logo" class="logo">
    </div>

    <p>Hi {user_name},</p>

    <p><em><strong>Welcome to SuperAgent — we're excited to have you on board!</strong></em></p>
    ...
    <p>Thanks again, and welcome to the SuperAgent community!</p>
  </div>
</body>
</html>"""
...
Welcome to SuperAgent — we're excited to have you on board!
  ...
  <tr>
    <td>
      ...
      <p style="margin:0 0 20px 0; font-size:15px; line-height:1.6;">
        <strong>{sender_name}</strong> has invited you to join SuperAgent using a personal referral code.
    ...
    <tr>
      <td>
        <div style="text-align: center; margin-bottom: 40px;">
          <img src="https://kortix.com/Logomark.svg" alt="SuperAgent" style="height: 24px; width: auto; display: inline-block;" />
        </div>
...
{sender_name} has invited you to join SuperAgent using a personal referral code.
