...
interface SunaModesState {
  ...
  setInitialParameters: (parameters: any) => void;
}
...
export const useSunaModesStore = create<SunaModesState>()(
  persist(
    (set, get) => ({
      ...
      setInitialParameters: (parameters: any) => {
        set({ initialParameters: parameters });
        // if(parameters){
        //   set({ initialParameters: {...(get().initialParameters || {}), ...parameters} });
        // }else{
        //   set({ initialParameters: null });
        // }
      },
